...
const Test = () => {
  return (
    <div className="position-relative">
          ...
          <div className="row">
            <div className="col-12 col-sm-9 offset-sm-1 col-xl-10 offset-xl-1 offset-xxl-0">
              <div className="hero-content home-one">
                <h3 className="ff-montez heading-line text-transparent" data-delay="0.3">
                  Experience Unmatched Delight With Us.
                </h3>
                <h2 className="text-white mb-4 heading-line text-transparent" data-delay="0.6">
                  Where Exceptional Memories Begin
                </h2>
                <p className="text-white heading-line text-transparent" data-delay="0.7">
                  ...
                  <form className="row align-items-center g-3 g-xxl-2" action="#">
                    ...
                    <div className="col-12 col-md-6 col-xxl">
                      <div className="search-item d-flex align-items-center gap-3">
                        ...
                        <div className="form-group">
                          <label for="tour-type" className="form-label">
                            Tour Type
                          </label>
                          <select
                            name="tour-type"
      ...
      <section className="hero-section  position-absolute top-0">
